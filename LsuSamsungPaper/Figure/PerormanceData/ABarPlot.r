...
pdf("/home/hadoop/rough/MyGITProjects/PGA_EvaluationArchitecturePaper/Evaluation-architectures-for-big-data/LsuSamsungPaper/Figure/PerormanceData/Plots/PerfDiffArch.pdf", family="Times")

# Grouped Bar Plot
data <- read.csv(file="PerfDiffArch.csv",head=TRUE,sep=",")
print(data)
...
#Plot for perf
barplot(as.matrix(data), main="", ylim=c(0, 3), xlab="Assembly Stages",ylab="Execution-time (s): Normalized to SuperMikeII", names=c("Graph-\nConstruction", "Graph-\nSimplification", "Scaffolding","Entire-\nPipeline"), col=c("black", "darkblue","blue", "darkred", "red", "darkgreen", "green", "magenta", "grey"), beside=TRUE, density=20, angle=c(45,0,0,30,30,135,135,90,135), cex.lab=1.3, cex.axis=1.5, cex.names=1.2)
barplot(as.matrix(data), add=TRUE, main="", ylim=c(0, 5), xlab="Assembly Stages",ylab="Execution-time (s): Normalized to SuperMikeII", names=c("Graph-\nConstruction", "Graph-\nSimplification", "Scaffolding","Entire-\nPipeline"), col=c("black", "darkblue","blue", "darkred", "red", "darkgreen", "green", "magenta", "grey"), beside=TRUE, density=20, angle=c(45,90,45,90,45,90,45,90,135), cex.lab=1.3, cex.axis=1.5, cex.names=1.2)
...
#Plot for perf (hum)
#barplot(as.matrix(data), main="", ylim=c(0, 1.5), xlab="Assembly Stages",ylab="Execution-time (s): Normalized to SuperMikeII", names=c("Graph-\nConstruction", "Graph-\nSimplification"), col=c("black", "darkblue","blue"), beside=TRUE, density=20, angle=c(45,0,0), cex.lab=1.3, cex.axis=1.5, cex.names=1.2)
#barplot(as.matrix(data), add=TRUE, main="", ylim=c(0, 1.5), xlab="Assembly Stages",ylab="Execution-time (s): Normalized to SuperMikeII", names=c("Graph-\nConstruction", "Graph-\nSimplification"), col=c("black", "darkblue","blue"), beside=TRUE, density=20, angle=c(45,90,45), cex.lab=1.3, cex.axis=1.5, cex.names=1.2)
#legend("topright", legend = rownames(data), fill = c("black", "darkblue","blue"), density=20, angle=c(45,0,0), ncol = 1, cex = 1)
#legend("topright", legend = rownames(data), fill = c("black", "darkblue","blue"), density=20, angle=c(45,90,45), ncol = 1, cex = 1)
#box()
...
#legend("topleft", legend = rownames(data), fill = c("black", "darkblue","blue"), density=20, angle=c(45,0,0), ncol = 1, cex = 1)
#legend("topleft", legend = rownames(data), fill = c("black", "darkblue","blue"), density=20, angle=c(45,90,45), ncol = 1, cex = 1)
#box()
