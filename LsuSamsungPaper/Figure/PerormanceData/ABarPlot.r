...
pdf("/home/hadoop/rough/MyGITProjects/PGA_EvaluationArchitecturePaper/Evaluation-architectures-for-big-data/LsuSamsungPaper/Figure/PerormanceData/Plots/PerfDiffArchHum.pdf", family="Times")

# Grouped Bar Plot
data <- read.csv(file="PerfDiffArchHum.csv",head=TRUE,sep=",")
print(data)
...
#legend("topright", legend = rownames(data), fill = c("black", "darkblue","blue"), density=20, angle=c(45,0,0), ncol = 1, cex = 1.2)
#legend("topright", legend = rownames(data), fill = c("black", "darkblue","blue"), density=20, angle=c(45,90,45), ncol = 1, cex = 1.2)
#box()
