...
# Grouped Bar Plot
data <- read.csv(file="newPerfPerDollarDiffArch.csv",head=TRUE,sep=",")
print(data)
...
#Plot for perf
#barplot(as.matrix(data), main="", ylim=c(0, 3), xlab="Assembly Stages",ylab="Execution-time normalized to SuperMikeII", names=c("Graph-\nConstruction", "Graph-\nSimplification", "Entire-\nPipeline"), col=c("black", "darkblue","blue", "darkred", "red", "darkgreen", "green", "magenta", "grey"), beside=TRUE, density=20, angle=c(45,0,0,30,30,135,135,90,135), cex.lab=1.8, cex.axis=1.5, cex.names=1.2)
#barplot(as.matrix(data), add=TRUE, main="", ylim=c(0, 5), xlab="Assembly Stages",ylab="Execution-time normalized to SuperMikeII", names=c("Graph-\nConstruction", "Graph-\nSimplification" ,"Entire-\nPipeline"), col=c("black", "darkblue","blue", "darkred", "red", "darkgreen", "green", "magenta", "grey"), beside=TRUE, density=20, angle=c(45,90,45,90,45,90,45,90,135), cex.lab=1.8, cex.axis=1.5, cex.names=1.2)
